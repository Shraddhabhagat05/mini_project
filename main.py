...
if menu_option == '🏠 Home':
    ...
    image = Image.open("C:/Users/NEXUS/Downloads/shopping-online.jpg")

# Display the image
    st.image(image, caption="Discover Your Style: Your Personalized Fashion Product Recommendation System")
